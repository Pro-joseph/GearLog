...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/Pro-joseph/GearLog.git](https://github.com/Pro-joseph/GearLog.git)
    ```
2.  **Navigate to the project folder:**
    ```bash
    cd "project sass"
    ```
3.  **Open `..view/index.php`** in your favorite browser.

## 🧠 What I Learned
During this project, I deepened my understanding of:
* How to fetch data / How to built CRUD / How built default components for Dashboard
* How to use **SASS Variables** to manage a design system efficiently.
* Creating **Mixins** and **Functions** to reduce code duplication (DRY principle).
* Structuring large stylesheets using the **@import or @use** rules for better maintainability.
